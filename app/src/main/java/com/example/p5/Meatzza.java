...
public class Meatzza extends Pizza{
    private static final double SMALL = 15.99;
    private static final double MEDIUM = 17.99;
    private static final double LARGE = 19.99;
    private static final double NOT_FOUND = -1;

    /**
     * Constructor for Meatzza
     */
    public Meatzza() {
        super();
    }
    ...
    public String toString(){
        String string = "(Meatzza) - Size: " + this.getSize().toString() + " - Crust: " +
    ...
    public Pizza duplicate(){
        if (this.getCrust().equals(Crust.STUFFED)){
            ...
            Pizza copy = copier.createMeatzza();
